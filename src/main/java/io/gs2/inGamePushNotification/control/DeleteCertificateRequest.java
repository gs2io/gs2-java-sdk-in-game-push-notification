...
public class DeleteCertificateRequest extends Gs2UserRequest<DeleteCertificateRequest> {

	public static class Constant extends Gs2InGamePushNotification.Constant {
		public static final String FUNCTION = "DeleteCertificate";
	}
	 ...
	 * @return this
	 */
	public DeleteCertificateRequest withGameName(String gameName) {
